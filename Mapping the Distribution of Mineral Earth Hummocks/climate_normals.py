...
Description:
This Python script processes hourly climate data from Trail Valley Creek and generates climate normals (1991-2020) by aggregating temperature and precipitation measurements to monthly means. 
It produces a visualization showing mean air temperature, temperature range (min-max envelope), and monthly precipitation totals across the 30-year period. 
The script handles data quality issues including gap-filling and unit conversions (Kelvin to Celsius, precipitation rates to depths).
